...
class SendSmsMail extends StatefulWidget {
  const SendSmsMail({Key? key}) : super(key: key);

  @override
  State<SendSmsMail> createState() => _SendSmsMailState();
}

class _SendSmsMailState extends State<SendSmsMail> {
  @override
...
class MyAppState extends State<MyApp> {
  ...
  _sendMessage(String phoneNumber, String message, {int? simSlot}) async {
    ...
    if (result == SmsStatus.sent) {
      print("Sent");
      for (var element in SmsStatus.values) {
        print(" sms: ${element.name}");
      }
    } else {
      print("Failed");
    }
